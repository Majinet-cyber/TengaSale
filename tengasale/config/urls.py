...
urlpatterns = [
    ...
    path("api/payments/airtel/health/", payment_api_views.airtel_health, name="airtel_health"),
    path("api/payments/airtel/readiness/", payment_api_views.airtel_readiness, name="airtel_readiness"),
