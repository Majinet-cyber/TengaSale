...
MIDDLEWARE = [
    ...
    "earnings.middleware.EarningsRelockMiddleware",
...
UPYA_ENABLED = os.environ.get("UPYA_ENABLED", "false").lower() in ("true", "1", "yes", "on")
UPYA_MANAGE_BASE_URL = os.environ.get("UPYA_MANAGE_BASE_URL", "https://data.upya.io")
UPYA_MANAGE_USERNAME = os.environ.get("UPYA_MANAGE_USERNAME", "")
UPYA_MANAGE_PASSWORD = os.environ.get("UPYA_MANAGE_PASSWORD", "")
UPYA_PAYMENT_GATEWAY_BASE_URL = os.environ.get("UPYA_PAYMENT_GATEWAY_BASE_URL", "https://mm.api.upya.io")
UPYA_PAYMENT_GATEWAY_USERNAME = os.environ.get("UPYA_PAYMENT_GATEWAY_USERNAME", "")
UPYA_PAYMENT_GATEWAY_PASSWORD = os.environ.get("UPYA_PAYMENT_GATEWAY_PASSWORD", "")
UPYA_PAYMENT_GATEWAY_CLIENT_IDENTIFIER = os.environ.get("UPYA_PAYMENT_GATEWAY_CLIENT_IDENTIFIER", "")
UPYA_WEBHOOK_API_KEY = os.environ.get("UPYA_WEBHOOK_API_KEY", "")
UPYA_WEBHOOK_API_KEY_HEADER = os.environ.get("UPYA_WEBHOOK_API_KEY_HEADER", "api-key")
UPYA_CONNECT_TIMEOUT = float(os.environ.get("UPYA_CONNECT_TIMEOUT", "5"))
UPYA_READ_TIMEOUT = float(os.environ.get("UPYA_READ_TIMEOUT", "10"))
USSD_ENABLED = os.environ.get("USSD_ENABLED", "false").lower() in ("true", "1", "yes", "on")
USSD_PROVIDER = os.environ.get("USSD_PROVIDER", "generic")
USSD_SERVICE_CODE = os.environ.get("USSD_SERVICE_CODE", "")
USSD_SESSION_TTL_MINUTES = int(os.environ.get("USSD_SESSION_TTL_MINUTES", "10"))
USSD_LOOKUP_RATE_LIMIT = int(os.environ.get("USSD_LOOKUP_RATE_LIMIT", "20"))
USSD_LOOKUP_RATE_WINDOW = int(os.environ.get("USSD_LOOKUP_RATE_WINDOW", "60"))
...
# How long a PENDING or INITIATED attempt remains "active" before it is considered stale.
# A stale attempt is marked EXPIRED so customers are not permanently blocked.
AIRTEL_PENDING_EXPIRY_MINUTES = int(os.environ.get("AIRTEL_PENDING_EXPIRY_MINUTES", "15"))
...
AIRTEL_PENDING_CALLBACK_TIMEOUT_MINUTES = int(os.environ.get("AIRTEL_PENDING_CALLBACK_TIMEOUT_MINUTES", "30"))
AIRTEL_CALLBACK_EVIDENCE_RETENTION_DAYS = int(os.environ.get("AIRTEL_CALLBACK_EVIDENCE_RETENTION_DAYS", "2555"))
