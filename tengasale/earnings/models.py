...
class EarningsRecoveryChallenge(models.Model):
    ...
    PURPOSE_CHOICES = [(PURPOSE_ENABLE, "Enable lock"), (PURPOSE_RESET, "Reset PIN"), (PURPOSE_DISABLE, "Disable lock")]
