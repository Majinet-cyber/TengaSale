...
class UserProfile(models.Model):
    ...
    earnings_access = models.BooleanField(default=True, help_text="Role permission to view protected earnings surfaces.")
    ...
    earnings_security_generation = models.PositiveIntegerField(default=0, editable=False)
    earnings_relock_minutes = models.PositiveSmallIntegerField(default=0, choices=[(0, "When leaving Earnings"), (1, "After 1 minute"), (5, "After 5 minutes"), (15, "After 15 minutes")])
